...
if($site_photo){$search_types["photo"]=1;$xsearch++;}
if($site_video){$search_types["video"]=1;$xsearch++;}
if($site_audio){$search_types["audio"]=1;$xsearch++;}
if($site_vector){$search_types["vector"]=1;$xsearch++;}
