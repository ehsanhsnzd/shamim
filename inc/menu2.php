...
?>var TREE_ITEMS =[['', '', {'tt' : '', 'sb':'','hte':{'oncontextmenu':'return h_context_menu_root(o_tree_item)','style':''}},<?
$itg="";



	if (!$smarty->is_cached('buildmenu4.tpl',"buildmenu|4"))
	{
		$nlimit=0;
		buildmenu4(5);
	}
	$smarty->cache_lifetime = -1;
	$smarty->assign('buildmenu4', $itg);
	$itg=$smarty->fetch('buildmenu4.tpl',"buildmenu|4");
