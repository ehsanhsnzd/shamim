            ...
            <div class="panel-heading">
                <h5 class="panel-title">
                    <i class="fa fa-plus" aria-hidden="true"></i><a
                            title="<?= cat_name($service_row['cat']) . ' ' . $p_type . ' ' . $color_type; ?>"
                            data-toggle="collapse" data-parent="#accordion"
                            href="#<?= $cat . $p_type . $count ?>"><?= cat_name($service_row['cat']) . ' ' . $p_type . ' ' . $color_type; ?></a>
                </h5>
            </div>
                ...
                <div class="panel-body">
                    ...
                    <table class="Price">
                        ...
                        while ($service_row_cat = mysqli_fetch_array($service_sql_cat)) {
                            ...
                            $c++;
                            if ($c % 2 == 0) {
                                $style_bg = "style='background-color:#DDDDDD'";
                            } else {
                                $style_bg = "";
                            }
                                ...
                                <td class="Row_Price">
                                    ...
                                    <table class="MainPrice">
                                        ...
                                        while ($service_row_type = mysqli_fetch_array($service_sql_type)) {
                                            ...
                                            if ($service_row_type['print_type'] == 1) {
                                                $printtype = "تک رو";
                                            } elseif ($service_row_type['print_type'] == 2) {
                                                $printtype = "دو رو";
                                            } else {
                                                $printtype = "-";
                                            }
                                                            ...
                                                            <a href="<?= "users/new-order-graphic.php?service=$service_id&catagory=$catagory&p_type=$p_type&color_type=$color_type&fast_type=$fast_type&paper_type=$paper_type&print_type=$print_type&size_type=$size_type&factor_type=$factor_type&ghabz_type=$ghabz_type&pocket_type=$pocket_type&riso_paper_type=$riso_paper_type&quantity=1th&lot=1" ?>">
                                                                <table class="Header_Price">
                                                                    <tr <?= $style_bg ?>>
                                                                        ...
                                                                        <td><?= $printtype ?></td>
                                                                        <td><?= $service_row_type['size_type'] ?>
                                                                            -<?= $service_row_type['size'] ?>
                                                                            <div>
                                                                        ...
                                                                        <td class="With_26"><? $discount = $service_row_type['price' . $j] * $percent;
                                                                            echo number_format($service_row_type['price' . $j] - $discount) ?></td>
                                                                        <td><span class="fa-shopping-basket"></span>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </a>
...
function showqty2($service, $percent_discount)
{
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h5 class="panel-title">
                <i class="fa fa-plus" aria-hidden="true"></i><a title="لارج فرمت" data-toggle="collapse"
                                                                data-parent="#accordion" href="#large">لارج فرمت</a>
            </h5>
        </div>
                                                ...
                                                <a href="<?= "users/new-order.php?service=$service_id&quantity=1th&lot=1" ?>">
                                                    <table class="Header_Price">
                                                        <tr <?= $style_bg ?>>
                                                            ...
                                                            <td class="With_26"><? $discount = $service_row_type['price1'] * $percent;
                                                                echo number_format($service_row_type['price1'] - $discount) ?></td>
