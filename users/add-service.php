...
if(isset($_POST['name']) && $_POST['name'] != '' && 
	...
	if (!isset($service_name) || $service_name == '' || !isset($service_size) || $service_size == '' || !isset($service_quantity1) || $service_quantity1 == '' || !isset($service_price1) || $service_price1 == ''){
		...
		$sql = "INSERT INTO services (name, size,size_h, quantity1, price1, quantity2, price2, quantity3, price3, quantity4, price4, work_time)
		VALUES ('$service_name', '$service_size','$service_size_h', '$service_quantity1', '$service_price1', '$service_quantity2', '$service_price2', '$service_quantity3', '$service_price3', '$service_quantity4', '$service_price4', '$service_worktime')";
...
?>
	<h2>افزودن خدمات</h2><br/>
		<form action="add-service.php" method="post" id="service-add-form">
			<input type="text" name="name" id="add_service_name" placeholder="نام خدمت*" required><br/>
