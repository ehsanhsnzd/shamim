...
if (isset($_POST['username']) && isset($_POST['password'])){
	...
	mysqli_select_db($connection, $db_name) or die("<span class=\"login-alert\">مشکلی در انتخاب پایگاه داده پیش آمد لطفا چند لحظه دیگر دوباره بررسی کنید و در صورت مشکل با مدیر سیستم در میان بگذارید.</span>");
				...
				if ($result = $connection->query("SELECT * FROM user WHERE username = '$username' AND password = '$pass_coded' and accept=1")) {
		...
		<div class="header-maxwidth"><img src="../library/images/logo2.jpg" >
          ...
          <a href="/report.php"><li>  ثبت شکایات</li></a>
			...
			<li style="width:100px"></li>
			  ...
			  <div class="header-buttons"><a href=" /users/login.php"><button class="login-button">ورود</button></a><a href=" /users/register.php"><button class="register-button">ثبت نام</button></a></div>
			</nav>
		</div>
	</header>
...
<div id="user-login-maxwidth">
	...
	<section id="users-login-page-section">
		...
		اگر تا کنون عضو وب سایت شمیم نشده اید، همین الان ثبت نام کنید تا از خدمات سایت استفاده کنید. پروسه ثبت نام حدود یک دقیقه طول می کشد. </p><a href="register.php" id="users-password-recovery">ثبت نام در شمیم</a>
	</section>
</div>
