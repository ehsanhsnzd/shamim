   ...
   <? include_once('../menu2.tpl');?>  
        ...
        <form id="upload_form" name="upload_form" enctype="multipart/form-data" method="post">
                        <div id="order-form-type-div">
                                <h3 class="user-panel-sheet-h3">تسلیت:</h3>
...
/><span><img onclick="changeText(<? echo $selg['id'] ?>,this)" src="../banner/Banner-<? echo $_GET['service'].'-'. $selg['id'].$selg['ext']; ?>" /> </span>
...
<br>
                      ...
                      عکس   (اگر موجود می باشد) :  
                  <input type="file" name="file3" id="file3" accept="image/jpg, image/jpeg, image/tiff" required  >      
 ...
 document.getElementById('order_make_format').onchange = function() {
    document.getElementById('halghe').disabled = !this.checked;
                        ...
                        <div id="order-form-description-div">
                                ...
                                <textarea id="order-form-description" name="order-description" placeholder="از طرف خانواده ... تسلیت به خانواده معزا ...."></textarea> 
                        </div>
