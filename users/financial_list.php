...
$sql_invoices_of_user = mysqli_query($connection, "SELECT * FROM factor where  date(date_create) between '$datefrom' and '$dateto' and (is_paid=1 or operator like '%shamim%')  and operator='$user_id_value' order by date_show DESC
");
