...
<body>
    ...
    <article class="page-sheet">
        <h3>تعرفه خدمات</h3>
        <p>
            در صورتی که سوالی دارید می توانید با ایمیل shamimtable@gmail.com در تماس باشید. روش دیگر تماس با ما تلفن ما می باشد: 041335577927
        </p>
    </article>
