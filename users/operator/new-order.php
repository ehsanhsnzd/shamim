...
<progress id="progressBar" value="0" max="100" style="width:300px; display:none  "></progress> 
        ...
        <form id="upload_form" name="upload_form" enctype="multipart/form-data" method="post">
                        ...
                        <div id="order-form-upload-div">
                                ...
                                <label for="order-file-1">عرض سفارشی:</label></td><td  style="font-size:9px"> عرض رول<br>
...
<? if( $_GET['service']==32){ ?>
                           ...
                           <? }elseif( $_GET['service']==31){ ?>
                            ...
                            <select name="meter" id="meter" style="font-size:14px; " onChange=" updateInput(this.value) ">
                                ...
                                <? }?>
                                </td><td><span  style="font-size:9px">کمتر از متراژ  رول می تواند باشد</span>
                   <br><input type="text" name="order-custom-height" id="upload-div-order-height" placeholder="عرض خود را انتخاب کنید"  onChange="handleChange(this);"  value="100">
          </td><td><br>

                                <label for="order-file-2">طول سفارشی:</label>
                                   <input type="text" name="order-custom-width" id="upload-div-order-width" placeholder="طول خود را انتخاب کنید" style="font-size:14px"    >
                                </td>
                            </tr>
    ...
    document.getElementById('halghe').disabled = !this.checked;
                        ...
                        <div id="order-form-description-div">
                                <h3 class="user-panel-sheet-h3">توضیحات:</h3>
                                   شماره فاکتور :    <input name="invoice_num" value=""  id="invoice_num" style="width:50px" >
