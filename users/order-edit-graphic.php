...
<a href=\"".$sql_od_file4."\" >دانلود</a>";
				...
				echo "<form id=\"order-edit-form\" action=\"order-edit-graphic.php?id=$id\" method=\"post\">";?>
				<input type="text" value="فاکتور:<?=$sql_od_invoice_code."-" .$sql_od_type?> " style="display:none" name="text_type"/>
