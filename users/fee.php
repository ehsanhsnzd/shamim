                ...
                <div id="<?=$cat.$p_type.$count?>" class="panel-collapse collapse">
                    <div class="panel-body">
                      ...
                      <table class="Price">
                           ...
                           <?  	$service_sql_cat=mysqli_query($connection, "SELECT * FROM $service  where  cat=$cat  and p_type='$p_type' and color_type='$color_type' group by name order by size_type,quantity1");
