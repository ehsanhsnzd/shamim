...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true) {
    	...
    	global $lphoto;
        $this->options = array(
            'script_url' => surl.site_root.'/members/upload_photo_jquery.php',
            'upload_dir' => $_SERVER["DOCUMENT_ROOT"].site_root."/content/user_".$_SESSION["people_id"]."/",
            'upload_url' => surl.site_root."/content/user_".$_SESSION["people_id"]."/",
           ...
           // 'upload_url' => $this->get_full_url().'/files/',
            ...
            'image_versions' => array(
                ...
                */
                'thumbnail' => array(
                    'max_width' => $global_settings["thumb_width"],
                    'max_height' => $global_settings["thumb_height"]
                )
