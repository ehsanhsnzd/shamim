...
<td><span class="price"><b><?=currency(1);?><?=float_opt($rs->row["total"],2)?> <?=currency(2);?></b></span> (<?=$rs->row["rates"]?>%)</td>
</tr>
<?
}
$n++;
...
<p><b><?=word_lang("total")?>:</b> <span class="price"><b><?=currency(1);?><?=float_opt($total,2)?> <?=currency(2);?></b></span></p>


<?
echo(paging2($n,$str,$kolvo,$kolvo2,"affiliate.php","&d=2"));
}
else
{
