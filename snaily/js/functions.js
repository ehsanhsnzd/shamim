    ...
    var createSnail = function(){
        ...
        function Countdown() {
              ...
              if (date.length !== 3) {return;}
                ...
                $('.countdown').html('<div id="counter">' + 
                      ...
                      '<div class="span2 col">&nbsp;</div><div class="span2 col">' +
                        ...
                        '<div id="days" class="info"><span class="number">1</span><p>روز</p></div>' +
                      '</div>' +
                      '<div class="span2 col">' +
                        '<div id="hoursChart" class="chart"></div>' +
                        '<div id="hours" class="info"><span class="number">1</span><p>ساعت</p></div>' +
                      '</div>' +
                      '<div class="span2 col">' +
                        '<div id="minutesChart" class="chart"></div>' +
                        '<div id="minutes" class="info"><span class="number">1</span><p>دقيقه</p></div>' +
                      '</div>' +
                      '<div class="span2 col">' +
                        '<div id="secondsChart" class="chart"></div>' +
                        '<div id="seconds" class="info"><span class="number">1</span><p>ثانيه</p></div>' +
                      '</div>' +
                    '</div>' +
                  '</div>');
            ...
            this.checkDate = function() {
                ...
                var spelling = {
                    days:    [countdown.attr('day') ? countdown.attr('day') : "day", countdown.attr('days') ? countdown.attr('days') : "روز"],
                    hours:   [countdown.attr('hour') ? countdown.attr('hour') : "hour", countdown.attr('hours') ? countdown.attr('hours') : "ساعت"],
                    minutes: [countdown.attr('minute') ? countdown.attr('minute') : "minute", countdown.attr('minutes') ? countdown.attr('minutes') : "دقیقه"],
                    seconds: [countdown.attr('second') ? countdown.attr('second') : "second", countdown.attr('seconds') ? countdown.attr('seconds') : "ثانیه"],
                };
