...
<?php include ("sidebar.php");?>
	...
	$sql_order_details = mysqli_query($connection, "SELECT * FROM orders WHERE order_id = '$orderID'");
...
mysqli_query($connection, "UPDATE orders set read_m=1 WHERE order_id = $orderID");
