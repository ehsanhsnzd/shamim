<ul>
	<li class="first"><a  href="#" class="lbox">{lang.Login}</a></li>
	<li><a href='{SITE_ROOT}members/signup.php'>{WORD_SIGNUP}</a></li>
	{if seller}
		<li><a href='{SITE_ROOT}members/signup.php?utype=seller&step=1'>{lang.Become a seller}</a></li>
	{/if}
	{if affiliate}
		<li><a href='{SITE_ROOT}members/signup.php?utype=affiliate&step=1'>{lang.Become an affiliate}</a></li>
	{/if}
</ul>
