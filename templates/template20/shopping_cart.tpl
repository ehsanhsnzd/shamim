...
<div id="lightbox_content">
	...
	<td>
		<div class="white_t"><div class="white_b"><div class="white_l"><div class="white_r"><div class="white_bl"><div class="white_br"><div class="white_tl"><div class="white_tr">
				<img src="{IMAGE}" width="{WIDTH}" height="{HEIGHT}" style="width:{WIDTH}px;height:{HEIGHT}px">
...
<div id="lightbox_footer">
	...
	<input type="button" value="{lang.Checkout}" class="lightbox_button2" onClick="pvs_shopping_cart_add('{SITE_ROOT}',1)">
	<input type="button" value="{lang.Continue Shopping}" class="lightbox_button" onClick="pvs_shopping_cart_add('{SITE_ROOT}',0)">
</div>
</form>