    ...
    req.onreadystatechange = function() {
        ...
        for(i=0;i<ar_menu.length;i++)
        {
        	if(ar_menu[i]==ctype)
        	{
        		...
        		$('#menu_'+ctype).hover(function() {
              		$(this).stop().animate({ backgroundColor: "#5b9510"}, 600);
         		},function() {
              		$(this).stop().animate({ backgroundColor: "#da3c43" }, 600);
          		});   
        	}
        	else
        	{
        		document.getElementById('menu_'+ar_menu[i]).className="tact2";
        		$('#menu_'+ar_menu[i]).css("background-color","#949393"); 
        		$('#menu_'+ar_menu[i]).hover(function() {
              		$(this).stop().animate({ backgroundColor: "#da3c43"}, 600);
          		},function() {
              		$(this).stop().animate({ backgroundColor: "#949393" }, 600);
          		});  
        	}
        }
