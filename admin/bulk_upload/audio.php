...
You should upload files here <b><?=surl?><?=site_root?><?=audiopreupload?></b> on FTP<br><br>
...
<table border=0 cellpadding=7 cellspacing=1 class=table_admin style="width:100%">
<tr>
...
if(file_exists($_SERVER["DOCUMENT_ROOT"].site_root.audiopreupload))
{
$dir = opendir ($_SERVER["DOCUMENT_ROOT"].site_root.audiopreupload);
