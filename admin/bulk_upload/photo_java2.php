...
$photo_sizes=$site_thumb_width."x".$site_thumb_width.",".$site_thumb_width2."x".$site_thumb_width2;
...
{		
	if($rs->row["size"]!=0)
	{
		if($rs->row["size"]!=$site_thumb_width and $rs->row["size"]!=$site_thumb_width2)
		{
...
<div class="subheader">You should select images and then click "Upload"</div>
