...
if(!isset($_SESSION['entry_admin'])){exit;}
if(!isset($_SESSION["author_id"])){exit;}
...
$upload_dir = $_SERVER[ 'DOCUMENT_ROOT' ] .site_root. "/content/user_".$_SESSION["author_id"]."/";

//
//    specify stage directory - temporary storage 
//    for uploaded partitions
$stage_dir = $_SERVER[ 'DOCUMENT_ROOT' ] .site_root. "/content/user_".$_SESSION["author_id"]."/";
