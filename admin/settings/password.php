...
<td><input type="password" name="p0" class="ft" style="width:100"></td>
</tr>
<tr class='snd'>
<td><?=word_lang("newpassword")?></td>
<td><input type="password" name="p1" class="ft" style="width:100"></td>
</tr>
<tr>
<td><?=word_lang("confirmpassword")?></td>
<td><input type="password" name="p2" class="ft" style="width:100"></td>
</tr>
</table>
