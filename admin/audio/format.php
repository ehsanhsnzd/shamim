...
?>
<form method="post" action="format_add.php" style="margin-bottom:20px">
...
$tr=1;
$n=0;
$sql="select * from audio_format order by name";
$rs->open($sql);
if(!$rs->eof)
{
?>
<form method="post" action="format_delete.php">
...
<td class="tab1"><input type="checkbox" id="m<?=$rs->row["id"]?>" name="m<?=$rs->row["id"]?>" value="1"></td>
