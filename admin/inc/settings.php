...
$menu_admin[]="orders";
$menu_admin_name[]="<i class='icon-briefcase icon-white'></i> ".word_lang("orders");

$menu_admin[]="catalog";
$menu_admin_name[]="<i class='icon-folder-open icon-white'></i> ".word_lang("catalog");

$menu_admin[]="users";
$menu_admin_name[]="<i class='icon-user icon-white'></i> ".word_lang("users");

$menu_admin[]="settings";
$menu_admin_name[]="<i class='icon-cog icon-white'></i> ".word_lang("settings");

$menu_admin[]="templates";
$menu_admin_name[]="<i class='icon-th-list icon-white'></i> ".word_lang("templates");

$menu_admin[]="pages";
$menu_admin_name[]="<i class='icon-book icon-white'></i> ".word_lang("text pages");

if($global_settings["affiliates"]==1)
{
	$menu_admin[]="affiliates";
	$menu_admin_name[]="<i class='icon-globe icon-white'></i> ".word_lang("affiliates");
}
...
$submenu_admin["settings_prices"]=word_lang("prices");
$submenu_admin_url["settings_prices"]="../prices/";

$submenu_admin["settings_licenses"]=word_lang("license");
...
if($global_settings["allow_video"]==1)
{
	...
	$submenu_admin["settings_ffmpeg"]="FFMPEG";
