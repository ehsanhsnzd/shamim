...
$sql="select id,title from lightboxes where id>0 ";
...
<td><div class="link_lightbox"><a href="../catalog/index.php?search=<?=$rs->row["title"]?>&search_type=lightbox"><?=$rs->row["title"]?></a></div></td>
