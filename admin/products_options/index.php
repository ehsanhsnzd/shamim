...
<a class="btn btn-success toright" href="content.php"><i class="icon-plane icon-white"></i> <?=word_lang("add")?></a>
...
<input type="submit" class="btn" value="<?=word_lang("save")?>" style="margin:15px 0px 0px 6px">
