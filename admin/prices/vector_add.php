...
$sql="insert into vector_types (types,price,priority,title,license,shipped) values ('".result($_POST["types"])."',".(float)$_POST["price"].",".(int)$_POST["priority"].",'".result($_POST["title"])."',".(int)$_POST["license"].",".$shipped.")";
$db->execute($sql);
