...
if(isset($_POST['submit'])){
	...
	$service_quantity4 = '0';
	$service_price4 = '0';
    $delivery_status_change= $_POST['delivery_status_change'];
	...
	require ('../db_select.php');
		...
		$sql = "UPDATE delivery SET status = '$delivery_status_change' where delivery_id = $requestID";
    ...
    echo "Error: " . $sql . "<br>" . $connection->error;
		...
		echo "<form id=\"delivery_request-edit-form\" action=\"delivery-request-edit.php?requestID=$requestID\" method=\"post\">";
		...
		$row = mysqli_fetch_array($dbresult);
			...
			echo "<input type=\"submit\" value=\"ثبت ویرایش درخواست ارسال\" name='submit'><br/>";
