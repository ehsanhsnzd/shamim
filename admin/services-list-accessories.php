...
<?php include ("sidebar.php");?>
	...
	<?php
		...
		if (isset($id) && isset($do) && $do == 'delete') {
			...
			$delete_record="DELETE FROM services3 WHERE id='$id'";
		...
		require ('../db_select.php');
	$sql_services_count = mysqli_query($connection, "SELECT * FROM services3 ORDER BY id DESC");
	...
	if(isset($page) && $page != '' && $page >=  1){
		...
		$dbresult=mysqli_query($connection, "SELECT * FROM services3 ORDER BY id LIMIT $start , $end");
...
?>
		<table id="services-edit-table">
			...
			echo "<tr>";
				...
				echo "<td><a href=\"edit-service-accessories.php?id=$services_table_service_id&do=edit\"><span class=\"table-edit-icon\"></span></a></td>";
				echo "<td><a href=\"services-list-accessories.php?id=$services_table_service_id&do=delete\"><span class=\"table-delete-icon\"></span></a></td>";
			echo "<tr>";
			}
			?>
		</table>
