...
<a class="btn btn-success toright" href="new.php"><i class="icon-tags icon-white"></i> <?=word_lang("credits")?></a>
...
$sql="select id_parent,title,quantity,user,data,approved,expiration_date from credits_list where id_parent>0 ";
...
{
?>
<div class="link_payment"><a href="../orders/payments.php?product_id=<?=$rs->row["id_parent"]?>&product_type=credits&print=1" target="blank"><?=word_lang("purchase statement")?></a></div></td>
<?
}
?>
