...
<?php include ("sidebar.php");?>
	...
	$sql_order_details = mysqli_query($connection, "SELECT * FROM orders2 WHERE order_id = '$orderID'");
...
$sql_od_lot_last= $sql_od['last_lot'];
					...
					$sql_od_type = $sql_od['order_type'].' ['.$sql_od['p_type'].' '.$sql_od['color_type'].' '.$sql_od['print_type'].' '.$sql_od['size_type'].' '.$sql_od['paper_type'].' '.$sql_od['factor_type'].' '.$sql_od['ghabz_type'].']';
...
mysqli_query($connection, "UPDATE orders2 set read_m=1 WHERE order_id = $orderID");}
