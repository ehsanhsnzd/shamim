...
<?php include ("sidebar.php");?>
	...
	$sql_order_details = mysqli_query($connection, "SELECT * FROM orders1 WHERE order_id = '$orderID'");
...
mysqli_query($connection, "UPDATE orders1 set read_m=1 WHERE order_id = $orderID");}
 ...
 <div style=\"background-image:url('$sql_od_file4');\" class=\"imgback\" >
  ...
  <a href=\"download.php?download_file=$sql_dw_file1\" class=\"downloadbutton\" ></a>
	 ...
	 <p>تعداد : <span class=\"order-detail-bg\">$sql_od_lot_quantity</span></p> </td></tr>";
					echo "</table>";
					echo "<span class=\"print-button\"><a href=\"javascript:window.print()\">چاپ صفحه</a></span>";
					echo "<span class=\"print-button\"><a href=\"order-edit.php?id=".$orderID."\">ویرایش سفارش</a></span>";
