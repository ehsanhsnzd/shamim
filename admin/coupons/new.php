...
<input type='text' name='title' style='width:200px' class='ibox' value='New coupon'>
</div>
<div class='admin_field'>
<span><?=word_lang("user")?>:</span>
<input type='text' name='user' style='width:200px' class='ibox' value=''>
</div>

<div class='admin_field'>
<span><?=word_lang("limit of usage")?>:</span>
<input type='text' name='limit_of_usage' style='width:100px' class='ibox' value='1'>
</div>

<div class='admin_field'>
<span><?=word_lang("total discount")?>:</span>
<input type='text' name='total' style='width:100px' class='ibox' value='0'>
</div>


<div class='admin_field'>
<span><?=word_lang("percentage discount")?>:</span>
<input type='text' name='percentage' style='width:100px' class='ibox' value='0'>
</div>


<div class='admin_field'>
<span><?=word_lang("free download")?> URL:</span>
<input type='text' name='url' style='width:300px' class='ibox' value=''>
</div>
...
<input type='text' name='days' style='width:100px' class='ibox' value='30'>
</div>
