...
$sql="select id_parent,touser,fromuser,subject,content,data from messages where id_parent>0 ";
...
<th class="hidden-phone hidden-tablet"><?=word_lang("from")?></th>
<th class="hidden-phone hidden-tablet"><?=word_lang("to")?></th>
<th><?=word_lang("subject")?></th>
...
<td><div class="link_message"><?=$rs->row["subject"]?></dov></td>
