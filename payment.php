...
// $invoice= mysqli_insert_id($connection);
 ...
 $amount=$fetch_amount['cash_off'].'0';
}
...
if(isset($_GET['amount'])){
	$amount_balance=$_GET['amount']. 0;
	
	}
elseif(isset($_POST['amount'])){
	$amount_balance=$_POST['amount']. 0;}
...
<input type="number" name="amount" value="<?= $amount?>" <? if(isset($_POST['amount'])){echo " disabled";}?> /> ریال<br>
<br>
