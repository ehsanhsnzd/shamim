...
<input type="text" name="name" id="name" class="ibox" value="" style="width:250px">
</div>

<div class="form_field">
<span><b><?=word_lang("e-mail")?></b></span>
<input type="text" name="email" id="email" class="ibox" style="width:250px">
</div>

<div class="form_field">
<span><?=word_lang("telephone")?>:</span>
<input type="text" name="telephone" class="ibox" style="width:250px">
</div>

<div class="form_field">
<span><?=word_lang("contact method")?>:</span>
<select name="method" class="ibox" style="width:250px"><option value="by e-mail""><?=word_lang("by e-mail")?><option value="by phone""><?=word_lang("by phone")?></select>
</div>

<div class="form_field">
<span><b><?=word_lang("question")?>:</b></span>
<textarea name="question" id="question" class="ibox" style="width:500px;height:150px"></textarea>
</div>
